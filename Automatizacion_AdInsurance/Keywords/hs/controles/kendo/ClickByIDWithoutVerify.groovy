...
class ClickByIDWithoutVerify {
	@Keyword
	def clickElement(String testObjectId, String elementId) {
		KeywordUtil.logInfo("Selecting Id=" + elementId + ")")
