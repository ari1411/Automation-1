...
class NumericTextBox {
	 ...
	 */
	@Keyword
	def setValue(String idText, String valor) {
		KeywordUtil.logInfo("Setting Id=" + idText + ", Valor=" + valor)


		def strExec = '$(' + '"#' + idText + '").data("kendoNumericTextBox")';
		def strSelec = strExec + '.value(' + valor + ');';
