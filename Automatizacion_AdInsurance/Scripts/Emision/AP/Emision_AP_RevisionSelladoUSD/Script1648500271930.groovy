...
WebUI.sendKeys(findTestObject('Emision_AP_AltaPropuesta_Anulacion/inputProductorPrincipal'), Keys.chord(Keys.DOWN //AGROLUMI, LIHUEL
        //AGROLUMI, LIHUEL
        ))

WebUI.sendKeys(findTestObject('Emision_AP_AltaPropuesta_Anulacion/inputProductorPrincipal'), Keys.chord(Keys.ENTER //AGROLUMI, LIHUEL
        //AGROLUMI, LIHUEL
        ))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Emision_AP_RevisionSelladoUSD/input_moneda', 
    'TipoMonedaId_XmlValue', moneda //2
    )

// aqui copiar en una variable auxiliar monedaCambio
WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Alta de Pliza Nueva/_SelectTipoDocumento', 
    'TipoDocumentoId_XmlValue', TipoDocumentoId //2
    )
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Emision_AP_AltaPropuesta_Endoso_ActualizacionNomina/inputTipoDocAsegurado', 
    'TipoDocumentoAseguradoId', tipoDocAsegurado //6
    )
...
WebUI.scrollToElement(findTestObject('Emision_AP_RevisionSelladoUSD/dd_impuestoSellados'), 0)
// verificar la variable monedaCambio
...
WebUI.verifyElementText(findTestObject('Emision_AP_RevisionSelladoUSD/span_monedaResults1'), monedaDeseada)
