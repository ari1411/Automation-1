...
if (WebUI.verifyElementPresent(findTestObject('Emision_AP_PrecondicionAltaPolizasparaProrrogar/button_altaAsegurado'), 20, FailureHandling.OPTIONAL)) {
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_AltaPoliza_PersonaNu', 1, 14)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPoliza, 'Emision_AP_AltaPoliza_PersonaNu', 1, 15)
