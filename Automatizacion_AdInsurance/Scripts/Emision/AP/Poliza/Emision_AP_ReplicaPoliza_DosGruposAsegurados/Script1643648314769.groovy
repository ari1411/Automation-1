...
if (WebUI.verifyElementPresent(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/li_eliminar'), 1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/li_eliminar'))
} else if (WebUI.verifyElementPresent(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/li_eliminarBeta'), 1, 
    FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/li_eliminarBeta'))
}
...
WebUI.click(findTestObject('Page_Asegurado (Baja)/button_Eliminar'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.verifyElementNotPresent(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/a_menuDatosAsegurado2'), 1)
...
WebUI.verifyElementVisible(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/span_validInconsistenciasFrentePolizaYNomina'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/button_cerrar'))

WebUI.scrollToElement(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/a_quitarActividad2'), 1)

WebUI.delay(2)

WebUI.click(findTestObject('Emision_AP_ReplicaPoliza_DosGruposAsegurados/a_quitarActividad2'))
