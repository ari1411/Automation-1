...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_AltaPropIncomDatoCom', 1, 31)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPropuesta, 'Emision_AP_AltaPropIncomDatoCom', 1, 32)
