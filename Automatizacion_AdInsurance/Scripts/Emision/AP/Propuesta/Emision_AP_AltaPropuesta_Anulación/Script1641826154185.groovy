...
WebUI.callTestCase(findTestCase('Emision/AP/Poliza/Creacion_NuevoMovimiento_Full'), [('RamoId') : findTestData('Nuevas Operaciones').getValue(1, 1)
        ...
        , ('msgeErrorFaltaPropuestas2') : findTestData('Nuevas Operaciones').getValue(8, 1), ('consultaMovimientos') : findTestData('Nuevas Operaciones').getValue(4, 1)], 
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Edicion_AP_AltaProp_Anulacion', 1, 7)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(prodPrincMovs, 'Edicion_AP_AltaProp_Anulacion', 1, 8)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_AP_AltaProp_Anulacion', 1, 11)
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva/_MenuEmision'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_AP_AltaPropuesta_Anulacion/a_Emitir'))
