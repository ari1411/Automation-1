...
WebUI.click(findTestObject('Page_Modificacin de propuesta de Pliza Nueva - ACCIDENTES PERSONALES - 110204/button_En espera'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de propuesta de Pliza Nueva - ACCIDENTES PERSONALES - 110204/input_EstadoCotizacionMotivo', 
    'cboEstadoCotizacionMotivo', MotivoEsperaId)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_AltaPropuesta_PropEs', 1, 32)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPropuesta, 'Emision_AP_AltaPropuesta_PropEs', 1, 33)
