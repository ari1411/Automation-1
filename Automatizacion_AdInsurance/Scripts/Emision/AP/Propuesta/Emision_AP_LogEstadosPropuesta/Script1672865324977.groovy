...
WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado1'), 'Propuesta emitida')

WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado2'), 'Propuesta en espera')

WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado3'), 'Propuesta aceptada')
