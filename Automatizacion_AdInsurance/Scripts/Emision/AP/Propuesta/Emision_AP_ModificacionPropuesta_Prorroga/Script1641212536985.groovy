...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emsion_AP_ModifProp_Prorroga', 1, 7)
...
nombreTomador = WebUI.getText(findTestObject('Emision_AP_ModificacionPropuesta_Prorroga/labelApellidoRazonSocialTomador'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(tomador.contains(nombreTomador), true)
