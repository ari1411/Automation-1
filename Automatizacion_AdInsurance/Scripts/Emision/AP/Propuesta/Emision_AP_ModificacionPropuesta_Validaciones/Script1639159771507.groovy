...
WebUI.click(findTestObject('Page_Consulta de propuestas/li_listbox_Propuesta incompleta'))

FechaAnterior = CustomKeywords.'hs.utils.GetDate.GetFechaDMA'(CantDiasAntesFiltrar, false)

WebUI.setText(findTestObject('Page_Consulta de propuestas/input_Fecha propuesta hasta_FechaPropuestaTO'), FechaAnterior)
...
WebUI.setText(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/input_Fecha de propuesta_FechaPropuesta.Dat_42fff8'), 
    FechaErroneaPropuesta)

WebUI.click(findTestObject('Object Repository/Page_Alta de propuesta de Pliza Nueva - Autos/input_Fecha de fin de vigencia_FechaFinVige_96944a'), 
    FailureHandling.STOP_ON_FAILURE)

FechaInput = WebUI.getAttribute(findTestObject('Page_Modificacin de propuesta de Pliza Nuev_77de0e/input_Fecha de propuesta_FechaPropuesta.Dat_42fff8'), 
    'value')

if (FechaInput != '') {
    Utils.markErrorAndStop('ERROR: Se ingreso una fecha erronea en Fecha de Propuesta, y el campo deberia estar vacio.')
}

FechaPosterior = CustomKeywords.'hs.utils.GetDate.GetFechaDMA'(CantDiasDespuesFechaPropuesta, true)
...
WebUI.verifyTextPresent(MsjValidacionFechaPropuesta, false)

WebUI.click(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/button_Cerrar'))

FechaActual = CustomKeywords.'hs.utils.GetDate.GetFechaDMA'('0', true)

WebUI.setText(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/input_Fecha de propuesta_FechaPropuesta.Dat_42fff8'), 
    FechaActual)

WebUI.setText(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/input_Fecha de inicio de vigencia_FechaInic_05a41d'), 
    FechaActual)

WebUI.setText(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/input_Fecha de fin de vigencia_FechaFinVige_96944a'), 
    FechaPosterior)
...
WebUI.verifyTextPresent(MsjValidacionMail, false)

WebUI.click(findTestObject('Object Repository/Page_Modificacin de propuesta de Pliza Nuev_77de0e/button_Cerrar'))

WebUI.scrollToElement(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion14'), 
    GlobalVariable.WaitForLoad)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_ModificacionPropuest', 1, 32)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPropuesta, 'Emision_AP_ModificacionPropuest', 1, 33)
