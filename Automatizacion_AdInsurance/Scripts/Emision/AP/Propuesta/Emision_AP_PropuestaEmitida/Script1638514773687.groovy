...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_PropuestaEmitida', 1, 32)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPropuesta, 'Emision_AP_PropuestaEmitida', 1, 33)
...
WebUI.scrollToElement(findTestObject('Page_Consulta de movimientos/td_EstadoCotizacionDescripcion'), 5)

WebUI.verifyElementText(findTestObject('Page_Consulta de movimientos/td_EstadoCotizacionDescripcion'), EstadoCotizacion)

WebUI.scrollToElement(findTestObject('Page_Consulta de propuestas/a_Grupo endoso_k-button k-button-icontext k_0cde73'), 
    5)
