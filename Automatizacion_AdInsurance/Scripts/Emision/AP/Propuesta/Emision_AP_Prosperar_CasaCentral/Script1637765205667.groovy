...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_Prosperar_CasaCentra', 1, 41)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPropuesta, 'Emision_AP_Prosperar_CasaCentra', 1, 42)
...
WebUI.scrollToElement(findTestObject('Page_Asegurado (Nuevo)/_SelectTipoBeneficiario'), GlobalVariable.WaitForLoad)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('/Page_Asegurado (Nuevo)/_SelectGruposActividadDefinidos', 
    'MovimientoActividadId', GruposActividadDefMovId)
...
WebUI.click(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/li_Datos adicionales'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_Unidad operativa'), 
    'Unidad operativa')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_La Meridional'), 
    UnidadOperativa)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_Sucursal'), 
    'Sucursal')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_Casa Central'), 
    Sucursal)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_Centro de atencin'), 
    'Centro de atención')

//WebUI.verifyElementText(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/label_Telefnica'), CentroAtencion)
WebUI.click(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/li_Propuesta'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.verifyElementText(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Valor1'), ValorPropuesta_nPolizaRenovadaSISE)

WebUI.verifyElementText(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Valor2'), ValorPropuesta_CodAseg)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AP_Prosperar_CasaCentra', 1, 43)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPoliza, 'Emision_AP_Prosperar_CasaCentra', 1, 44)
