...
sumAsegOrigNum = ((sumAsegOrig) as Float)

print(sumAsegOrigNum)

sumAsegOrigNum = (sumAsegOrigNum * 0.8)

print(sumAsegOrigNum)

DecimalFormat df = new DecimalFormat('#.00')

sumAsegOrigNum = df.format(sumAsegOrigNum) // 800000.00

print(sumAsegOrigNum)

sumAsegOrig = sumAsegOrigNum.toString()

print(sumAsegOrig)

WebUI.click(findTestObject('Emision_AutoIndividual_Endoso_AumentoSumaAsegurada/span_sumaAseguradaAuto'))
...
WebUI.click(findTestObject('Emision_AutoFlota_Endoso_AumentoSumaAsegurada/input_sumaAseguradaTotal'))
...
WebUI.scrollToElement(findTestObject('Emision_AutoFlota_Endoso_AumentoSumaAsegurada/span_sumaAseguradaTotal1'), 1)

sumaTotal1 = WebUI.getText(findTestObject('Emision_AutoFlota_Endoso_AumentoSumaAsegurada/span_sumaAseguradaTotal1'))

sumaTotal1Pars = (sumaTotal1 - '.')

while (sumaTotal1 != sumaTotal1Pars) {
	sumaTotal1 = sumaTotal1Pars

	sumaTotal1Pars = (sumaTotal1 - '.')
}

sumaTotal1 = sumaTotal1.replace(',', '.')

sumaTotal1Num = sumaTotal1 as Float

sumaTotal2 = WebUI.getText(findTestObject('Emision_AutoFlota_Endoso_AumentoSumaAsegurada/span_sumaAseguradaTotal2'))

sumaTotal2Pars = (sumaTotal2 - '.')

while (sumaTotal2 != sumaTotal2Pars) {
	sumaTotal2 = sumaTotal2Pars

	sumaTotal2Pars = (sumaTotal2 - '.')
}

sumaTotal2 = sumaTotal2.replace(',', '.')

sumaTotal2Num = sumaTotal2 as Float

WebUI.verifyGreaterThan(sumaTotal2, sumaTotal1)
