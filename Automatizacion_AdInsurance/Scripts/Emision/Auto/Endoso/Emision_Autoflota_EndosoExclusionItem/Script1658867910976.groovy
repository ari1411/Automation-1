...
WebUI.click(findTestObject('Emision_Autoindividual_EndosoExclusionItem/a_menuExcluir'))

WebUI.click(findTestObject('Emision_Autoindividual_EndosoExclusionItem/li_excluir'))
