...
WebUI.setText(findTestObject('Page_Consulta de movimientos/input_Nmero endoso_NumeroEndoso'), NumeroEndoso)
...
WebUI.scrollToElement(findTestObject('Page_Consulta de movimientos/td_EstadoPolizaDescripcion'), 5)

if (!(WebUI.verifyElementText(findTestObject('Page_Consulta de movimientos/td_EstadoPolizaDescripcion'), EstadoPoliza, FailureHandling.OPTIONAL))) {
    CustomKeywords.'hs.utils.Screenshots.takeScreenshot'()

    Utils.markErrorAndStop('ERROR: La Póliza ingresada se encuentra anulada. Deben modificarlo desde el excel')
}

WebUI.scrollToElement(findTestObject('Object Repository/Page_Consulta de propuestas/a_Grupo endoso_k-button k-button-icontext k_0cde73'), 
    5)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_Autoflota_RechazarItem', 1, 10)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPoliza, 'Emision_Autoflota_RechazarItem', 1, 11)
