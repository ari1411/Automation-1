...
WebUI.sendKeys(findTestObject('Page_Modificacin de Pliza Nueva - Autos - 106633/input_Suma asegurada_SumaAsegurada.DecimalValue'), 
    SumaAsegurada)
...
WebUI.click(findTestObject('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/input_Motor_Motor.StringValue'), 
    FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_AutoIndividual_RepPol', 1, 6)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPoliza, 'Emision_AutoIndividual_RepPol', 1, 7)
