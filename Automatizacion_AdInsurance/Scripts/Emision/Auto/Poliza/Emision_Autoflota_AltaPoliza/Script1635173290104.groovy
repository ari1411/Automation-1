...
WebUI.sendKeys(findTestObject('Page_Modificacin de Pliza Nueva - Autos - 106633/input_Ao_Anio.XmlValue_input'), Keys.chord(
        Keys.DOWN))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Kilometraje', 
    'KilometrajeAutoId_XmlValue', Kilometraje_1)

WebUI.scrollToElement(findTestObject('Emision_Autoflota_AltaPoliza/span_sumaAsegurada'), 1)

/*
WebUI.click(findTestObject('Emision_Autoflota_AltaPoliza/span_sumaAsegurada'), FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Destino', 
    'DestinoAutoId_XmlValue', Destino_1)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Carroceria', 
    'CarroceriaAutoId_XmlValue', Carroceria_1)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Provincia', 
    'ProvinciaIdAuto_XmlValue', Provincia_1)
...
WebUI.delay(Integer.parseInt(EsperaLocalidad_1))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_ClausulaAjuste', 
    'ClausulaAjusteAutoId_XmlValue', ClausulaAjuste_1)
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva - Autos/_SelectAgregarAuto2'))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Kilometraje', 
    'KilometrajeAutoId_XmlValue', Kilometraje_2)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Destino', 
    'DestinoAutoId_XmlValue', Destino_2)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Carroceria', 
    'CarroceriaAutoId_XmlValue', Carroceria_2)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Provincia', 
    'ProvinciaIdAuto_XmlValue', Provincia_2)
...
WebUI.delay(Integer.parseInt(EsperaLocalidad_2))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_ClausulaAjuste', 
    'ClausulaAjusteAutoId_XmlValue', ClausulaAjuste_2)
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva - Autos/_SelectAgregarAuto3'))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Kilometraje', 
    'KilometrajeAutoId_XmlValue', Kilometraje_3)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Destino', 
    'DestinoAutoId_XmlValue', Destino_3)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Carroceria', 
    'CarroceriaAutoId_XmlValue', Carroceria_3)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_Provincia', 
    'ProvinciaIdAuto_XmlValue', Provincia_3)
...
WebUI.delay(Integer.parseInt(EsperaLocalidad_3))
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Modificacin de Pliza Nueva - Autos - 106633/_input_ClausulaAjuste', 
    'ClausulaAjusteAutoId_XmlValue', ClausulaAjuste_3)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nCotizacion, 'Emision_Autoflota_AltaPoliza', 1, 60)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(nPoliza, 'Emision_Autoflota_AltaPoliza', 1, 61)
