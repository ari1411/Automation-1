...
WebUI.click(findTestObject('Page_Vigencia Vigencia 1(26) 112019 - 31122050/td_Pesos-SumaAseguradaBase'))

WebUI.clearText(findTestObject('Page_Vigencia Vigencia 1(26) 112019 - 31122050/input_Pesos_SumaAseguradaBase'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_Vigencia Vigencia 1(26) 112019 - 31122050/td_Pesos-SumaAseguradaBase'))

WebUI.sendKeys(findTestObject('Page_Vigencia Vigencia 1(26) 112019 - 31122050/input_Pesos_SumaAseguradaBase'), SumaAsegurada)

WebUI.sendKeys(findTestObject('Page_Vigencia Vigencia 1(26) 112019 - 31122050/input_Pesos_SumaAseguradaBase'), Keys.chord(
        Keys.ENTER))
