...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Cauc_RevisionSelladoUSD', 1, 11)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emision_Cauc_RevisionSelladoUSD', 1, 12)
...
WebUI.mouseOver(findTestObject('Emision_AP_RevisionSelladoUSD/dd_impuestoSellados'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Emision_AP_RevisionSelladoUSD/span_valorCuotaUSD'), 0)
