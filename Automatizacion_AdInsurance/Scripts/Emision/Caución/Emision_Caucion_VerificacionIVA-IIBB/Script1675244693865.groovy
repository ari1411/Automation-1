...
CustomKeywords.'hs.controles.kendo.ClickByID.clickElement'('/Page_Alta de Pliza Nueva/li_Personas', 'Personas')

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.scrollToElement(findTestObject('Page_Alta de Pliza Nueva/div_divCondicionIva'), 5)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Alta de Pliza Nueva/input_CondicionIvaId_XmlValue', 
    'CondicionIvaId_XmlValue', CondicionIVA1)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Alta de Pliza Nueva/input_CondicionIIBBId_XmlValue', 
    'CondicionIIBBId_XmlValue', CondicionIIBB1)
...
WebUI.verifyTextPresent(MsjValidacion, false)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Alta de Pliza Nueva/input_CondicionIvaId_XmlValue', 
    'CondicionIvaId_XmlValue', CondicionIVA2)

CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Page_Alta de Pliza Nueva/input_CondicionIIBBId_XmlValue', 
    'CondicionIIBBId_XmlValue', CondicionIIBB2)
