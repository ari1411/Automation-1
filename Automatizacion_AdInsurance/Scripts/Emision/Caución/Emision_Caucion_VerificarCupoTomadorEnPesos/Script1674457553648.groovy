...
WebUI.setText(findTestObject('Object Repository/Page_Tomadores/input_Nro. Documento_FilterNumeroDocumento'), CUIT_Tomador)

WebUI.click(findTestObject('Object Repository/Page_Tomadores/a_Refrescar'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/a_EditarTomador'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/li_Balances'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

PatrimonioNeto = WebUI.getAttribute(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/input_PatrimonioNeto'), 
    'value')

Utils.logInfo(PatrimonioNeto)

ManifestacionBienes = WebUI.getAttribute(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/input_ManifestacionBienes'), 
    'value')

Utils.logInfo(ManifestacionBienes)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/li_Cumulo'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/a_refreshCumuloGrid'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

SumaAsegurada1 = WebUI.getText(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_7'))

Utils.logInfo(SumaAsegurada1)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/button_grabarTomador'))
...
WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdRiesgo_1_4'))

WebUI.sendKeys(findTestObject('Page_Alta de Pliza Nueva/_GrillaRiesgoSumaAsegurada'), IngresoSumaAsegurada1)
...
SumaAsegurada2 = WebUI.getText(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_7'))

Utils.logInfo(SumaAsegurada2)

SumaAsegurada1 = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoSinDecimales'(SumaAsegurada1)

SumaAseguradaActual = ((((SumaAsegurada1) as int) + ((IngresoSumaAsegurada1) as int)) as String)

SumaAsegurada2 = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoSinDecimales'(SumaAsegurada2)

if (SumaAseguradaActual == SumaAsegurada2) {
    Utils.logInfo('Valores correctos')
} else {
    CustomKeywords.'hs.utils.Screenshots.takeScreenshot'()

    Utils.markErrorAndStop('No Coinciden los valores de suma Asegurada ingresada en la poliza y el del tomador')
}
...
SumaAsegurada3 = WebUI.getText(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_7'))

Utils.logInfo(SumaAsegurada3)

SumaAsegurada3 = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoSinDecimales'(SumaAsegurada3)

if (SumaAseguradaActual == SumaAsegurada3) {
    Utils.logInfo('Valores correctos')
} else {
    CustomKeywords.'hs.utils.Screenshots.takeScreenshot'()
...
SumaAsegurada4 = WebUI.getText(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_7'))

Utils.logInfo(SumaAsegurada4)

SumaAsegurada4 = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoSinDecimales'(SumaAsegurada4)

if (SumaAseguradaActual == SumaAsegurada4) {
    Utils.logInfo('Valores correctos')
} else {
    CustomKeywords.'hs.utils.Screenshots.takeScreenshot'()
...
WebUI.sendKeys(findTestObject('Page_Alta de Pliza Nueva/_GrillaRiesgoSumaAsegurada'), IngresoSumaAsegurada2)

WebUI.sendKeys(findTestObject('Page_Alta de Pliza Nueva/_GrillaRiesgoSumaAsegurada'), Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_1'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.scrollToElement(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdCumulo_2_1'), GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/a_refreshCumuloPolizaGrid'))

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Emision_Caucion_VerificarCupoTomadorEnPesos/td_grdTomadorCumuloPoliza_1_1'))
