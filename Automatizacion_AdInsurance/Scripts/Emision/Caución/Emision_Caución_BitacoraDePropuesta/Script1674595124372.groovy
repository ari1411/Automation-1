...
WebUI.scrollToElement(findTestObject('Page_Alta de propuesta de Pliza Nueva - ACC_ca9b23/textarea_Bitcora_txtNuevaBitacora'), 
    0)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Cauc_BitacoraPropuesta', 1, 28)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPropuesta, 'Emision_Cauc_BitacoraPropuesta', 1, 29)
