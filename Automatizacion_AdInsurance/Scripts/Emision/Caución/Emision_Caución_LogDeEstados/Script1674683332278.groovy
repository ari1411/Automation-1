...
WebUI.click(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion13'))
...
WebUI.click(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Valor18'))
...
WebUI.click(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion18'))
...
WebUI.click(findTestObject('Emision_Caución_LogDeEstados/button_guardarMovimiento'))
...
WebUI.click(findTestObject('Emision_Caucion_AltaPropuesta_ValidacionVIgenciaAgente/button_modificar'))
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Caución_LogDeEstados', 1, 28)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPropuesta, 'Emision_Caución_LogDeEstados', 1, 29)
...
WebUI.click(findTestObject('Page_Consulta de propuestas/span_Log de estados'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado1'), 'Propuesta aceptada')

WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado2'), 'Propuesta en espera')

WebUI.verifyElementText(findTestObject('Emision_AP_LogEstadosPropuesta/td_logEstado3'), 'Propuesta incompleta')
