...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Cauc_ModifProp_PolNueva', 1, 29)
...
//WebUI.verifyElementText(findTestObject('Object Repository/Emision_AP_ModificacionPropuesta_PolizaNueva/spanProductorPrincipalResultados'),productorPrincipalCompleto)
WebUI.click(findTestObject('Emision_AP_ModificacionPropuesta_PolizaNueva/menuPropuesta1'))
