...
CustomKeywords.'hs.controles.kendo.ClickByID.clickElement'('Object Repository/Page_Alta de Pliza Nueva/li_Anexos y clusulas', 
    'AnexosClausulas')
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva/check_anexo'))
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva/a_anexo'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Page_Alta de Pliza Nueva/li_tabsAnexo-tab-1'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.setText(findTestObject('Page_Alta de Pliza Nueva/txt_txtTextoOriginal'), TextoAnexo)
...
WebUI.click(findTestObject('Page_Alta de Pliza Nueva/a_anexo_Consulta'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.click(findTestObject('Page_Alta de Pliza Nueva/li_tabsAnexo-tab-3'))

WebUI.waitForPageLoad(GlobalVariable.WaitForLoad)

WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)

WebUI.verifyTextPresent(TextoAnexo, false)
