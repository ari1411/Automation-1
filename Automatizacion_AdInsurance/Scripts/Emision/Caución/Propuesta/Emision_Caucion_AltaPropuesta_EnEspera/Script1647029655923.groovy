...
WebUI.click(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion22'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion29'), FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Object Repository/Emision_AP_MonitorDistribucion_ReasignacionMedianteRegla/comboMotivoEsperaVentEmergente', 
    'cboEstadoCotizacionMotivo', motivoGuardar)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Cauc_AltaProp_EnEspera', 1, 33)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(equipoDistribucion, 'Emision_Cauc_AltaProp_EnEspera', 1, 34)
