...
// 0:45 hay que agregarle el prodPrinc
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Cauc_AltaProp_ValidVigAgent', 1, 28)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPropuesta, 'Emi_Cauc_AltaProp_ValidVigAgent', 1, 29)
...
String FechaInicioVigencia = CustomKeywords.'hs.utils.GetDate.GetFechaDMA'(90, false)
