...
WebUI.callTestCase(findTestCase('Emision/Caución/Propuesta/Emision_Caucion_PropuestaIncompleta_SinDatos'), [('RamoId') : findTestData('Emision_Caucion_PropuestaIncompleta_SinDatos').getValue(1, 1)
        , ('SubRamoId') : findTestData('Emision_Caucion_PropuestaIncompleta_SinDatos').getValue(2, 1), ('estadoMovimiento') : findTestData('Emision_Caucion_PropuestaIncompleta_SinDatos').getValue(3, 1)], 
...
WebUI.scrollToElement(findTestObject('Page_Alta de propuesta de Pliza Nueva - Caucin/td_grdDatosPropuesta_Descripcion20'), 
    0)
...
numPoliza = (numPoliza - 'Número de propuesta: ')

CustomKeywords.'hs.utils.HSSFSupport.openWorkbook'('variables.xls')

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Cau_ModifPropIncomp_Emit', 1, 31)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Cau_ModifPropIncomp_Emit', 1, 32)
