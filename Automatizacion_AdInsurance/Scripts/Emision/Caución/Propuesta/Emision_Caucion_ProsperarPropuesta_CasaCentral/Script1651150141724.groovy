...
WebUI.click(findTestObject('Page_AdInsurance - Emisin/a_Consulta de propuestas'))
...
String FechaFinVigencia = CustomKeywords.'hs.utils.GetDate.GetFechaDMA'(DiasFechaFinVigencia, true //8
    )
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElementByName'('Object Repository/Page_Alta de propuesta de Pliza Nueva - Caucin/_SelectCboEquipoTecnico', 
    'EQUIPO', ValorPropuesta_eqTecnico //variable
    )
...
numDocTomador = WebUI.getAttribute(findTestObject('Page_Alta de propuesta de Pliza Nueva - Autos/input_Nmero de documento_NumeroDocumento.St_f6b89f'), 
    'value')

WebUI.verifyMatch(numDocTomador, nDocTomador, true)
...
numDocAsegurado = WebUI.getAttribute(findTestObject('Page_Alta de propuesta de Pliza Nueva - Autos/input_Nmero de documento_NumeroDocumento.St_f6b89f'), 
    'value')

WebUI.verifyMatch(numDocAsegurado, nDocAsegurado, true)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Cauc_ProspProp_CasaCent', 1, 40)
...
WebUI.waitForJQueryLoad(GlobalVariable.WaitForLoad)*/
// validar datos de tomador y asegurado
WebUI.click(findTestObject('Page_Modificacin de Pliza Nueva - ACCIDENTE_c08506/li_Propuesta'))
