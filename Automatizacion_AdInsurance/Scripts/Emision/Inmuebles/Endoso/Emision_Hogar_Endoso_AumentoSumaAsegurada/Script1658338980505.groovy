...
totalSumAsegOrig = WebUI.getText(findTestObject('Emision_Hogar_Endoso_AumentoSumaAsegurada/span_totalSumaAsegurada')) // '1.000.000,00'

totalSumAsegOrig = CustomKeywords.'hs.utils.convertString.stringFormatoNumerico'(totalSumAsegOrig) // '1000000.00'
...
WebUI.verifyGreaterThan(cantidadPosterior, cantidadOriginal)
