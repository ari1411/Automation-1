...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Hogar_ReplicaPoliza', 1, 4)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emision_Hogar_ReplicaPoliza', 1, 5)
