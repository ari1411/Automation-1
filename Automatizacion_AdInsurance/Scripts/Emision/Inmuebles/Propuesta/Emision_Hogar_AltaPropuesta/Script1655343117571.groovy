...
String numPropuesta = WebUI.getText(findTestObject('Object Repository/Page_Alta de Endoso - ACCIDENTES PERSONALES - 583528/h3_Nmero de pliza 000010100183'))

numPropuesta = (numPropuesta - 'Número de propuesta: ')

CustomKeywords.'hs.utils.HSSFSupport.openWorkbook'('variables.xls')

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Hogar_AltaPropuesta', 1, 29)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPropuesta, 'Emision_Hogar_AltaPropuesta', 1, 30)
