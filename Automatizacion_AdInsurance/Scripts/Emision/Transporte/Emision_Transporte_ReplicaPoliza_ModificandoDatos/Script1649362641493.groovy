...
WebUI.click(findTestObject('Emision_Transporte_GenerarPresupuesto/input_porcentajePrimaDeposito'))

WebUI.sendKeys(findTestObject('Emision_Transporte_GenerarPresupuesto/input_porcentajePrimaDepositoBeta'), porcentajePrimaDeposito)
