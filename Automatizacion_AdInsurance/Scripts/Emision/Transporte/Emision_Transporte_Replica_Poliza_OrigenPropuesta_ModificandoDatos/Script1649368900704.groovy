...
} else if ((WebUI.getText(findTestObject('Emision_AP_AltaPropuesta_Endoso/spanNumPolizaResultados10')) != campoNulo) && 
(WebUI.getText(findTestObject('Emision_AP_ReplicaPolizaOrigenPropuesta_SinModificarDatos/span_numeroPropuestaResultados10')) != 
campoNulo)) {
...
WebUI.click(findTestObject('Object Repository/Page_Alta de Pliza Nueva - Transporte de Me_b368c6/span_Porcentaje de prima depsito_k-numeric-_c8c629'))

WebUI.clearText(findTestObject('Emision_Transporte_GenerarPresupuesto/input_porcentajePrimaDepositoBeta'))

WebUI.click(findTestObject('Object Repository/Page_Alta de Pliza Nueva - Transporte de Me_b368c6/span_Porcentaje de prima depsito_k-numeric-_c8c629'))

WebUI.setText(findTestObject('Emision_Transporte_GenerarPresupuesto/input_porcentajePrimaDepositoBeta'), porcentajePrimaDeposito)
