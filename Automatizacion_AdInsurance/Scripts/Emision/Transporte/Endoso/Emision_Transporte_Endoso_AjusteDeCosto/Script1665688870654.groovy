...
WebUI.click(findTestObject('Emision_Hogar_Endoso_AjustedeCosto/input_porcentajeDescuento0'), FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Transp_Endos_AjustCosto', 1, 8)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emision_Transp_Endos_AjustCosto', 1, 9)
...
/*
PorcentajeDescuentoVerify = WebUI.getAttribute(findTestObject('Page_Alta de Endoso - Autos/input_PorcentajeDescuento.DecimalValue_2'), 
    'value')

WebUI.verifyEqual(PorcentajeDescuento, PorcentajeDescuentoVerify)
*/

PorcentajeDescuentoVerify = (PorcentajeDescuento + ',00')

WebUI.verifyElementText(findTestObject('Emision_Hogar_Endoso_AjustedeCosto/labelPorcentajeDescuento'), PorcentajeDescuentoVerify)
