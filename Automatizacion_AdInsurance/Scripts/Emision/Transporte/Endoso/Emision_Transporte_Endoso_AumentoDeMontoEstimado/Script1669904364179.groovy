...
montoEstimMayorNum = (montoEstimPrevioNum * 1.25).toInteger()

// print(montoEstimMenorNum)
montoEstimMayor = montoEstimMayorNum.toString()
...
WebUI.setText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/input_transitoAereoMontoEst1'), montoEstimMayor)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Transp_Endos_AumenMontEstim', 1, 7)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Transp_Endos_AumenMontEstim', 1, 8)
...
montoEstimMayorVerify = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoInverso'(montoEstimMayor)
...
WebUI.verifyElementText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/td_transitoAereoEditar'), montoEstimMayorVerify)