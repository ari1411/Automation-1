...
WebUI.setText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/input_transitoAereoMontoEst1'), montoEstimado)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Transp_Endoso_AumenSumAseg', 1, 7)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Transp_Endoso_AumenSumAseg', 1, 8)
...
WebUI.verifyElementText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/td_transitoAereoEditar'), '2.500.000,00')
