...
WebUI.setText(findTestObject('Object Repository/Page_Alta de Endoso - Transporte de Mercaderas/input_Localidad_LocalidadId.XmlValue_input'), 
    'avella')

WebUI.sendKeys(findTestObject('Object Repository/Page_Alta de Endoso - Transporte de Mercaderas/input_Localidad_LocalidadId.XmlValue_input'), 
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Transp_Endos_CmbioDatsTomad', 1, 8)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Transp_Endos_CmbioDatsTomad', 1, 9)
...
WebUI.verifyElementText(findTestObject('Page_Alta de Endoso - Transporte de Mercaderas/label_localidad'), 'PARQUE AVELLANEDA')
