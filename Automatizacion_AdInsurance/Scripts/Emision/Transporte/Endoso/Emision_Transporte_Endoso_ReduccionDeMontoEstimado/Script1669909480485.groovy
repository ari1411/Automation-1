...
WebUI.clickOffset(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/td_transitoAereoEditar'), 2, 0)

WebUI.click(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/span_transitoAereoMont1'))

WebUI.click(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/span_transitoAereoMont2'))

montoEstimPrevio = WebUI.getAttribute(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/input_transitoAereoMontoEst1'),
	'value')

// print(montoEstimPrevio)
montoEstimPrevioNum = montoEstimPrevio.toInteger()

// print(montoEstimPrevioNum)
montoEstimMenorNum = (montoEstimPrevioNum * 0.75).toInteger()

// print(montoEstimMenorNum)
montoEstimMenor = montoEstimMenorNum.toString()

// print(montoEstimMenor)
WebUI.click(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/tr_transitoAereoFila'))
...
WebUI.clearText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/input_transitoAereoMontoEst1'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/input_transitoAereoMontoEst1'), montoEstimMenor)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Transp_Endos_ReducMontEstim', 1, 7)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Transp_Endos_ReducMontEstim', 1, 8)
...
montoEstimMenorVerify = CustomKeywords.'hs.utils.convertString.stringFormatoNumericoInverso'(montoEstimMenor)
...
WebUI.verifyElementText(findTestObject('Emision_Transporte_Endoso_AumentoSumaAsegurada/td_transitoAereoEditar'), montoEstimMenorVerify)
