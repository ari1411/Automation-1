...
montoEstimMenorNum = (montoEstimPrevioNum * 0.8).toInteger()
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emi_Transp_Endoso_ReducSumAseg', 1, 7)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emi_Transp_Endoso_ReducSumAseg', 1, 8)
