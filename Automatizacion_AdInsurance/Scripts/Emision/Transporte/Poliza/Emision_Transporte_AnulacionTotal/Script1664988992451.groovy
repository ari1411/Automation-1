...
/*
WebUI.click(findTestObject('Emision_Transporte_AltaPolizaMensual/td_montoEstimadoTransitoAereo'))

WebUI.click(findTestObject('Emision_Transporte_AltaPolizaMensual/input_montoEstimadoTansitoAereo1'))

WebUI.setText(findTestObject('Emision_Transporte_AltaPolizaMensual/input_montoEstimadoTansitoAereo2'), '2000000')
*/

WebUI.click(findTestObject('Object Repository/Page_Alta de Pliza Nueva - Transporte de Me_b368c6/td_Transito areo_grdRiesgoTransporte_active_cell'))

WebUI.setText(findTestObject('Object Repository/Page_Alta de Pliza Nueva - Transporte de Me_b368c6/input_Transito areo_MontoEstimado'),
	'2000000')

WebUI.click(findTestObject('Object Repository/Page_Alta de Pliza Nueva - Transporte de Me_b368c6/div_Emisin                                 _c330f9'))
