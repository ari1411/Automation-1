...
WebUI.click(findTestObject('Emision_Transporte_AltaPropuesta/input_contacto'))
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Transp_ProsperPropuesta', 1, 30)
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Emision_Transporte_ProsperarPropuesta/input_productoId', 
...
CustomKeywords.'hs.controles.kendo.DropDownListBox.selectElement'('Emision_Transporte_ProsperarPropuesta/input_subProductoId', 
    'SubProductoId_XmlValue', subProductoId)
