...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Transp_ProspProp_Anulac', 1, 5)
...
WebUI.verifyElementText(findTestObject('Emision_AP_ModificacionPropuestaAceptada_GuardarEmitida/h4EstadoMovimiento'), estadoMovimiento0)

WebUI.verifyElementText(findTestObject('Emision_AP_ModificacionPropuestaAceptada_GuardarEmitida/h4EstadoCotizacion'), estadoCotizacion0)
...
CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numCotizacion, 'Emision_Transp_ProspProp_Anulac', 1, 11)

CustomKeywords.'hs.utils.HSSFSupport.updateSheet'(numPoliza, 'Emision_Transp_ProspProp_Anulac', 1, 12)
...
WebUI.verifyElementText(findTestObject('Emision_AP_Poliza_Rehabilitacion/span_EstadoPoliza1'), estadoPolizaDeseado, FailureHandling.OPTIONAL)
